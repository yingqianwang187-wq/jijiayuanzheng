...
# 变更记录：
#   v0.23（内容补全，设计文档 v0.25）：第 2~5 章各 10 关（Data.MAX_LEVEL 5→45）、
#       通关章节 BOSS 解锁下一章、第 2 章起 5v5 呈现（敌方每波 3~5 敌、§8.2 公式）、
#       章节 BOSS 首通大额奖励（金币/钻石+碎片3+宝石/装备）、旧档迁移；附录 A 数值定稿。
#       无新信号/新入口/新术语。
